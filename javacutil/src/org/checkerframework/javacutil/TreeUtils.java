    ...
    public static Tree getAssignmentContext(final TreePath treePath) {
        ...
        switch (parent.getKind()) {
            ...
            case VARIABLE:
                return parent;
            case MEMBER_SELECT:
                // Also check case when treepath's leaf tree is used as methohd invocation's actual receiver
                // If so, return that method invocation tree too as the assignment context tree rather than
